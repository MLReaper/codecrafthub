...
function renderStats(s) {
  statsEl.innerHTML = `
    ...
    <div class="stat-card not-started">
      ...
      <div class="stat-body">
        <div class="stat-value">${s["Not Started"]}</div>
    ...
    <div class="stat-card in-progress">
      ...
      <div class="stat-body">
        <div class="stat-value">${s["In Progress"]}</div>
        ...
        <div class="course-footer">
          <div class="course-meta-info">
            <div>
              Target:
              <strong>
                ${escapeHtml(formatDate(c.target_date))}
              </strong>
            </div>
...
async function loadCourses() {
  try {
    ...
    document.querySelector(".empty-hint").textContent =
...
form.addEventListener("submit", async (e) => {
  ...
  if (
    ...
    showError(
      "Please fill in the name, description, and target date."
    );
